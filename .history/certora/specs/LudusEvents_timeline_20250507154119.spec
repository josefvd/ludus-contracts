...
methods contract type LudusIdentityContract {
...
methods { // This is for LudusEventsImpl (the contract under verification)
    ...
    function startEvent(uint256) returns (bool) summary;
    function completeEvent(uint256, address[] memory, uint256[] memory) returns (bool) summary;
    function cancelEvent(uint256) returns (bool) summary;
