...
abstract contract Stub_LudusIdentity is ILudusIdentity {
    ...
    function mockSetOwner(uint256 profileId, address owner) public {
    ...
    function createProfile(string calldata, uint8) public returns (uint256) {
        _totalSupply++;
