...
abstract contract Stub_EAS is IEAS {
    ...
    function revoke(RevocationRequest calldata) public {}

    function revokeByDelegation(RevocationRequest calldata, address) public {}
    ...
    function getSchemaRegistry() public view returns (address) { return address(0); }
