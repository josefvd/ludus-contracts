...
rule checkCreateEventTreasuryDistribution(method f) filtered f.selector == createEvent(uint256, uint256, uint256, uint256, uint256, address, uint256, uint256, bool, string, string, string, string, string, string[], string[], uint256[], string[], uint256[], string[]).selector {
...
rule checkCreateEventTimeline(method f) filtered f.selector == createEvent(uint256, uint256, uint256, uint256, uint256, address, uint256, uint256, bool, string, string, string, string, string, string[], string[], uint256[], string[], uint256[], string[]).selector {
    // Declare env and arguments
    env e;
