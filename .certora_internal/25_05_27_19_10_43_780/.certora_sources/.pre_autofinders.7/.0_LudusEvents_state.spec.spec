...
function checkEventStateIsValid(uint256 eventId) returns bool {
    ...
    uint256 regFee_ev; LudusTypes.PaymentCurrency paymentCurrency_ev;
...
methods {
    ...
    function createEvent(bytes, bytes, bytes, bytes) external returns (uint256) optional; // Simplified signature
    function startEvent(uint256) external optional;
    // Using bytes for athletes array in completeEventAndDistribute
    function completeEventAndDistribute(uint256, bytes) external optional; // Simplified signature
