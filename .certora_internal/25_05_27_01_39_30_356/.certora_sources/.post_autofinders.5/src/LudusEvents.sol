...
abstract contract LudusEvents is Ownable, ReentrancyGuard, ISchemaResolver {
    ...
    function _canEnableYieldGeneration(uint256 eventId, uint256 amount) internal view returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000e0000, 1037618708494) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000e0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000e1000, eventId) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000e1001, amount) }
    ...
    function _validateCreateEventInputs(
    ...
    ) internal view {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00100000, 1037618708496) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00100001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00101000, params) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00101001, positions) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00101002, percentages) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00101003, attestationData) }
        ...
        for (uint256 i = 0; i < percentages.length; i++) {
            totalPercentage += percentages[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000026,totalPercentage)}
        }
    ...
    function _calculateTotalPrizePool(
        LudusTypes.EventCreationParams memory params, // Use struct param
        LudusTypes.EventAttestationData memory attestationData
    ) internal pure returns (uint256 totalPrizePool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00110000, 1037618708497) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00110001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00111000, params) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00111001, attestationData) }
        totalPrizePool = params.registrationFee * params.maxParticipants;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000023,totalPrizePool)}
        for (uint256 i = 0; i < attestationData.ticketPrices.length; i++) {
            totalPrizePool += attestationData.ticketPrices[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000027,totalPrizePool)}
        }
        for (uint256 i = 0; i < attestationData.sponsorshipPrices.length; i++) {
            totalPrizePool += attestationData.sponsorshipPrices[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000028,totalPrizePool)}
        }
    }
    ...
    function _storeEventDetails(
        ...
        uint256[] memory positions,
        uint256[] memory percentages
    ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000f0000, 1037618708495) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000f0001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000f1000, currentEventId) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000f1001, params) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000f1002, totalPrizePool) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000f1003, positions) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000f1004, percentages) }
    ...
    function _handleYieldAndAttestation(
        ...
        LudusTypes.EventCreationParams memory params, // Use struct param
        LudusTypes.EventAttestationData memory attestationData
    ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00120000, 1037618708498) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00120001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00121000, currentEventId) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00121001, params) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00121002, attestationData) }
    ...
    function startEvent(uint256 eventId) external {
        ...
        eventData.status = LudusTypes.EventStatus.Started;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020024,0)}
    ...
    function getParticipants(uint256 eventId) external view returns (uint256[] memory) {
        ...
        for (uint256 i = 0; i < count; i++) {
            result[i] = participants[i];uint256 certora_local41 = result[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000029,certora_local41)}
        }
    ...
    function _distributeFunds(
    ...
    ) internal returns (uint256 totalEthDistributed, uint256 totalUsdcDistributed) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00130000, 1037618708499) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00130001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00131000, eventId) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00131001, dist) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00131002, finalizedAthletes) }
        ...
        address organizerAddress = eventDetails.creator;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000f,organizerAddress)}
        
        LudusTypes.AthleteDistribution storage athleteDist = _athleteDistributions[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010010,0)}
        ...
        for (uint256 i = 0; i < finalizedAthletes.length; i++) {
                uint256 athleteShareEth = (athletesAmountEth * athleteDist.percentages[i]) / 10000;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002a,athleteShareEth)}
        ...
        if (eventPrizesUSDC[eventId] > 0) {
            ...
            for (uint256 i = 0; i < finalizedAthletes.length; i++) {
                uint256 athleteShareUsdc = (athletesAmountUsdc * athleteDist.percentages[i]) / 10000;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002b,athleteShareUsdc)}
    ...
    function completeEventAndDistribute(
        ...
        LudusTypes.Distribution memory dist = eventDistributions[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010011,0)}
        ...
        LudusTypes.AthleteDistribution storage athleteDist = _athleteDistributions[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010012,0)}
        ...
        (uint256 totalEthDistributed, uint256 totalUsdcDistributed) = _distributeFunds(eventId, dist, finalizedAthletes);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010013,0)}
        ...
        uint256 combinedTotalAmount = totalEthDistributed + totalUsdcDistributed;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000014,combinedTotalAmount)} // Note: This is a sum of potentially different units
        uint256 combinedAthletesAmount = (totalEthDistributed * dist.athletesShare / 10000) + (totalUsdcDistributed * dist.athletesShare / 10000);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000015,combinedAthletesAmount)}
        uint256 combinedOrganizerAmount = (totalEthDistributed * dist.organizerShare / 10000) + (totalUsdcDistributed * dist.organizerShare / 10000);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000016,combinedOrganizerAmount)}
        uint256 combinedCharityAmount = (totalEthDistributed * dist.charityShare / 10000) + (totalUsdcDistributed * dist.charityShare / 10000);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000017,combinedCharityAmount)}
        uint256 combinedPlatformFee = (totalEthDistributed * LUDUS_TAX_PERCENTAGE / 10000) + (totalUsdcDistributed * LUDUS_TAX_PERCENTAGE / 10000);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000018,combinedPlatformFee)}
    ...
    function cancelEvent(uint256 eventId) external nonReentrant {
        LudusTypes.EventDetails storage eventData = events[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010019,0)}
        ...
        if (msg.sender == eventData.creator) {
            ...
            if (participantCount > 0) {
                ...
                for (uint256 i = 0; i < participantCount; i++) {
                    address participantAddress = ludusIdentity.ownerOf(participants[i]);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002c,participantAddress)}
        ...
        uint256 currentParticipants = this.getParticipantCount(eventId);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001a,currentParticipants)}
        if (currentParticipants < eventData.minParticipantsToStart) {
            ...
            // Refund each participant
                ...
                address participantAddress = ludusIdentity.ownerOf(participants[i]);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002d,participantAddress)}
                     if (refundAmountETH > 0) {
                        (bool sent, ) = payable(participantAddress).call{value: refundAmountETH}("");
                        require(sent, "ETH refund transfer failed");
                    }
    ...
    function shouldEventBeCancelled(uint256 eventId) public view returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00170000, 1037618708503) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00170001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00171000, eventId) }
        LudusTypes.EventDetails storage eventData = events[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001001b,0)}
        ...
        uint256 currentParticipants = this.getParticipantCount(eventId);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001c,currentParticipants)}
        return currentParticipants < eventData.minParticipantsToStart;
    }

    // New function to stake ETH with the YieldManager
    function _stakeEventETH(uint256 eventId, uint256 amount) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00140000, 1037618708500) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00140001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00141000, eventId) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00141001, amount) }
    ...
    function withdrawEventETH(uint256 eventId) external {
        LudusTypes.EventDetails storage eventData = events[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001001e,0)}
        require(eventData.creator == msg.sender || msg.sender == owner(), "Not authorized");
        ...
        uint256 withdrawnAmount = yieldManager.withdrawEventFundsETH(eventId);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001f,withdrawnAmount)}
    ...
    function withdrawEventUSDC(uint256 eventId) external {
        LudusTypes.EventDetails storage eventData = events[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010020,0)}
        require(eventData.creator == msg.sender || msg.sender == owner(), "Not authorized");
        require(eventData.status == LudusTypes.EventStatus.Completed || 
                eventData.status == LudusTypes.EventStatus.Canceled, "Event must be completed or canceled");
        
        // Assumes YieldManager has withdrawEventFundsUSDC
        uint256 withdrawnAmount = yieldManager.withdrawEventFundsUSDC(eventId);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000021,withdrawnAmount)}
    ...
    function activateYieldGeneration(uint256 eventId) external nonReentrant {
        LudusTypes.EventDetails storage eventData = events[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010022,0)}
        ...
        eventData.yieldActivated = true;bool certora_local37 = eventData.yieldActivated;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000025,certora_local37)}
    }
} 