...
// Reverted rule signature back to filtering for createEvent and capturing return value directly.
...
{
    env e;
    // eventId is now directly available from the filtered signature
