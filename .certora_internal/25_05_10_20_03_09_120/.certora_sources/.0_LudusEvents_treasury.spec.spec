...
methods {
    ...
    function createEvent(bytes, bytes, bytes, bytes) summary;
    ...
    function enableETHYieldGeneration(uint256) summary;
    function registerParticipant(uint256,uint256) summary;
    function withdrawEventETH(uint256) summary;
