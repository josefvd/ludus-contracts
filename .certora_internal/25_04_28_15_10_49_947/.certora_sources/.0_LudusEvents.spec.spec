...
rule checkCreateEventTimeline(method f)
    filtered f.call(
        ...
        uint256 registrationEndTime, 
        uint256 maxParticipants, 
        address organizerAddress, // Assuming this is arg 5
        uint256 registrationFeeUSDC, 
        uint256 registrationFeeETH, 
        bool preferYieldGeneration, // Assuming this is arg 8
        string name, 
        ...
        uint256[] sponsorshipPrices, 
        string[] sponsorshipTierNames,
        // Other args we don't directly use in this rule
    ...
    ) returns uint256 eventId
{
    ...
    // Arguments startTime, endTime, registrationStartTime, registrationEndTime are now directly available
