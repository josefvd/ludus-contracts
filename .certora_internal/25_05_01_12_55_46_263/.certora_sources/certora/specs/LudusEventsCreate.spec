...
rule checkPropertiesAfterEventCreated() {
    // Declare variables to capture event arguments
    uint256 eventId;
    string name; // String type might require specific handling
    uint256 eventStartTime;
    uint256 eventEndTime;
    
    // Capture the last emitted EventCreated event (assigning to declared vars)
