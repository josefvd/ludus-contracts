...
contract YieldManager is Ownable, IYieldManager {
    ...
    function _wrapETH(uint256 amount) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d10000, 1037618708689) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d10001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d11000, amount) }
        IWETH(WETH_ADDRESS).deposit{value: amount}();
        emit ETHWrapped(amount);
    }
    
    // Helper function to unwrap WETH to ETH
    function _unwrapWETH(uint256 amount) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d20000, 1037618708690) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d20001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d21000, amount) }
    ...
    function getATokenAddress(address asset) public view returns (address) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d40000, 1037618708692) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d40001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d41000, asset) }
    ...
    function _calculateTimeWeightedYield(
        ...
        uint256 startTime,
        uint256 currentTime
    ) internal pure returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d30000, 1037618708691) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d30001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d31000, principal) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d31001, startTime) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d31002, currentTime) }
