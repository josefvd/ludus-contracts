...
methods {
    ...
    function events(uint256) external returns (uint256 id, uint256 startTime, uint256 endTime, uint256 regStartTime, uint256 regEndTime, uint256 maxParticipants, address creator, address organizerAddress, types.EventStatus status, uint256 regFeeETH, uint256 regFeeUSDC, uint256 totalPrize, bool prefYield) envfree;
...
rule createEventPostStateCheck() filtered f {
    require f.call(
