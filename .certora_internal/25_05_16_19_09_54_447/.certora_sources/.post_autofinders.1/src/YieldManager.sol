...
contract YieldManager is Ownable, IYieldManager {
    ...
    constructor(address payable _events, address _aavePool, address _usdc, address _weth) Ownable(msg.sender) {
    ...
    function _wrapETH(uint256 amount) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001a0000, 1037618708506) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001a0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001a1000, amount) }
        IWETH(WETH_ADDRESS).deposit{value: amount}();
        emit ETHWrapped(amount);
    }
    
    // Helper function to unwrap WETH to ETH
    function _unwrapWETH(uint256 amount) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001b0000, 1037618708507) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001b0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001b1000, amount) }
    ...
    function approveAavePool() external onlyOwner {
        ...
        // Approve USDC
        uint256 currentAllowance = _USDC.allowance(address(this), AAVE_POOL);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000001,currentAllowance)}
        if (currentAllowance > 0) {
            bool resetSuccess = _USDC.approve(AAVE_POOL, 0);
            require(resetSuccess, "Failed to reset USDC allowance");
        }
        bool successUSDC = _USDC.approve(AAVE_POOL, type(uint256).max);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000002,successUSDC)}
        require(successUSDC, "Failed to approve USDC spending");
        emit ApprovalUpdated(address(_USDC), AAVE_POOL, type(uint256).max);
        
        // Approve WETH
        currentAllowance = _WETH.allowance(address(this), AAVE_POOL);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002d,currentAllowance)}
        if (currentAllowance > 0) {
            bool resetSuccess = _WETH.approve(AAVE_POOL, 0);
            require(resetSuccess, "Failed to reset WETH allowance");
        }
        bool successWETH = _WETH.approve(AAVE_POOL, type(uint256).max);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000003,successWETH)}
    ...
    function enableYieldGeneration(uint256 eventId) external {
        EventYield storage eventYield = eventYields[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010004,0)}
        ...
        if (eventYield.stakedAmount > 0 && !eventYield.isGeneratingYield) {
            ...
            if (currentAllowance < eventYield.stakedAmount) {
                SafeERC20.forceApprove(_USDC, AAVE_POOL, 0);
                SafeERC20.forceApprove(_USDC, AAVE_POOL, type(uint256).max);
            }
        ...
        if (eventYield.stakedAmountETH > 0 && !eventYield.isGeneratingYieldETH) {
            ...
            if (currentAllowance < eventYield.stakedAmountETH) {
                SafeERC20.forceApprove(_WETH, AAVE_POOL, 0);
                SafeERC20.forceApprove(_WETH, AAVE_POOL, type(uint256).max);
            }
    ...
    function getATokenAddress(address asset) public view returns (address) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001d0000, 1037618708509) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001d0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001d1000, asset) }
        DataTypes.ReserveData memory reserveData = aavePool.getReserveData(asset);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010005,0)}
        return reserveData.aTokenAddress;
    }
    
    // Renamed from stakeEventFunds to stakeEventFundsUSDC
    function stakeEventFundsUSDC(uint256 eventId, uint256 amount) external override {
        ...
        EventYield storage eventYield = eventYields[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010006,0)}
        uint256 previousStake = eventYield.stakedAmount;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000007,previousStake)}
        eventYield.stakedAmount = previousStake + amount;uint256 certora_local46 = eventYield.stakedAmount;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002e,certora_local46)}
    ...
    function stakeEventFundsETH(uint256 eventId) external payable {
        ...
        EventYield storage eventYield = eventYields[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010008,0)}
        uint256 previousStake = eventYield.stakedAmountETH;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000009,previousStake)}
        eventYield.stakedAmountETH = previousStake + msg.value;uint256 certora_local47 = eventYield.stakedAmountETH;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002f,certora_local47)}
    ...
    // Renamed from withdrawEventFunds to withdrawEventFundsUSDC
    function withdrawEventFundsUSDC(uint256 eventId) external returns (uint256 totalAmount) {
        require(msg.sender == address(events), "Only events contract can withdraw funds");
        
        EventYield storage eventYield = eventYields[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001000a,0)}
        require(eventYield.stakedAmount > 0, "No USDC funds staked");
        
        uint256 yieldAmount = 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000b,yieldAmount)}
        uint256 amountToReturn = eventYield.stakedAmount;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000c,amountToReturn)}
        ...
        uint256 oldStakedAmount = eventYield.stakedAmount;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000d,oldStakedAmount)}
        eventYield.stakedAmount = 0;uint256 certora_local48 = eventYield.stakedAmount;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000030,certora_local48)}
    ...
    function withdrawEventFundsETH(uint256 eventId) external returns (uint256 totalAmount) {
        ...
        EventYield storage eventYield = eventYields[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001000e,0)}
        require(eventYield.stakedAmountETH > 0, "No ETH funds staked");
        
        uint256 yieldAmount = 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000f,yieldAmount)}
        uint256 amountToReturn = eventYield.stakedAmountETH;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000010,amountToReturn)}
        ...
        uint256 oldStakedAmount = eventYield.stakedAmountETH;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000011,oldStakedAmount)}
        eventYield.stakedAmountETH = 0;uint256 certora_local49 = eventYield.stakedAmountETH;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000031,certora_local49)}
        eventStakesETH[eventId] = 0;
        
        // Unwrap WETH to ETH and transfer to events contract
        _unwrapWETH(amountToReturn);
        (bool success, ) = address(events).call{value: amountToReturn}("");assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010012,0)}
    ...
    function _calculateTimeWeightedYield(
        ...
        uint256 startTime,
        uint256 currentTime
    ) internal pure returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001c0000, 1037618708508) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001c0001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001c1000, principal) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001c1001, startTime) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001c1002, currentTime) }
        if (currentTime <= startTime) return 0;
        
        // Calculate time elapsed in days (using 365 days as base)
        uint256 timeElapsed = currentTime - startTime;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000013,timeElapsed)}
        uint256 daysElapsed = timeElapsed / 1 days;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000014,daysElapsed)}
        
        // Base APY of 5% (500 basis points) for calculation
        uint256 baseAPY = 500;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000015,baseAPY)}
        
        // Calculate yield: principal * (APY/10000) * (daysElapsed/365)
        uint256 yield = (principal * baseAPY * daysElapsed) / (365 * 10000);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000016,yield)}
        
        return yield;
    }

    function getEventYield(uint256 eventId) external view returns (uint256) {
        EventYield storage eventYield = eventYields[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010017,0)}
        ...
        uint256 aTokenBalance = IERC20(getATokenAddress(USDC_ADDRESS)).balanceOf(address(this));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000018,aTokenBalance)}
        uint256 expectedYield = _calculateTimeWeightedYield(
            eventYield.stakedAmount,
            eventYield.stakingStartTime,
            block.timestamp
        );assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000019,expectedYield)}
        uint256 actualYield = aTokenBalance > eventYield.stakedAmount ?
            aTokenBalance - eventYield.stakedAmount : 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001a,actualYield)}
    ...
    function getEventYieldETH(uint256 eventId) external view returns (uint256) {
        EventYield storage eventYield = eventYields[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001001b,0)}
        ...
        uint256 aTokenBalance = IERC20(getATokenAddress(WETH_ADDRESS)).balanceOf(address(this));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001c,aTokenBalance)}
        uint256 expectedYield = _calculateTimeWeightedYield(
            eventYield.stakedAmountETH,
            eventYield.stakingStartTime,
            block.timestamp
        );assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001d,expectedYield)}
        uint256 actualYield = aTokenBalance > eventYield.stakedAmountETH ?
            aTokenBalance - eventYield.stakedAmountETH : 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001e,actualYield)}
    ...
    function emergencyWithdraw(uint256 eventId) external onlyOwner {
        EventYield storage eventYield = eventYields[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001001f,0)}
        bool hasUSDC = eventYield.stakedAmount > 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000020,hasUSDC)}
        bool hasETH = eventYield.stakedAmountETH > 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000021,hasETH)}
    ...
    function setDistribution(
        ...
        uint256 platformFee = 300;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000022,platformFee)} // 3%
        ...
        EventYield storage eventYield = eventYields[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010023,0)}
        eventYield.athletesShare = _athletesShare;uint256 certora_local50 = eventYield.athletesShare;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000032,certora_local50)}
        eventYield.organizerShare = _organizerShare;uint256 certora_local51 = eventYield.organizerShare;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000033,certora_local51)}
        eventYield.charityShare = _charityShare;uint256 certora_local52 = eventYield.charityShare;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000034,certora_local52)}
        eventYield.charityAddress = _charityAddress;address certora_local53 = eventYield.charityAddress;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000035,certora_local53)}
    ...
    function getDistribution(uint256 eventId) external view returns (
        ...
        EventYield storage eventYield = eventYields[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010024,0)}
        return (
    ...
    function getEventTotalFunds(uint256 eventId) external view returns (uint256) {
        EventYield storage eventYield = eventYields[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010025,0)}
    ...
    function getEventTotalFundsETH(uint256 eventId) external view returns (uint256) {
        EventYield storage eventYield = eventYields[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010026,0)}
    ...
    function updateEventYield(uint256 eventId) external returns (uint256) {
        EventYield storage eventYield = eventYields[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010027,0)}
        if (eventYield.stakedAmount == 0) return 0;
        require(eventYield.isGeneratingYield, "USDC yield generation not enabled");

        // Get current aToken balance
        uint256 aTokenBalance = IERC20(getATokenAddress(USDC_ADDRESS)).balanceOf(address(this));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000028,aTokenBalance)}
        require(aTokenBalance >= eventYield.stakedAmount, "Insufficient aToken balance");

        // Calculate current yield
        uint256 currentYield = aTokenBalance > eventYield.stakedAmount ? 
            aTokenBalance - eventYield.stakedAmount : 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000029,currentYield)}
            
        return currentYield;
    }
    
    function updateEventYieldETH(uint256 eventId) external returns (uint256) {
        EventYield storage eventYield = eventYields[eventId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001002a,0)}
        if (eventYield.stakedAmountETH == 0) return 0;
        require(eventYield.isGeneratingYieldETH, "ETH yield generation not enabled");

        // Get current aToken balance
        uint256 aTokenBalance = IERC20(getATokenAddress(WETH_ADDRESS)).balanceOf(address(this));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002b,aTokenBalance)}
        require(aTokenBalance >= eventYield.stakedAmountETH, "Insufficient aWETH balance");

        // Calculate current yield
        uint256 currentYield = aTokenBalance > eventYield.stakedAmountETH ? 
            aTokenBalance - eventYield.stakedAmountETH : 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002c,currentYield)}
